...
def parse_args():
    ...
    make_html_parser = parser.add_subparsers('make-html', description='Wrapper around Pdf2HtmlEX to better handle forms')
    ...
    fill_pdf_parser = parser.add_subparsers('fill-pdf', description='Fill form data into the PDF, including pasting images for signature fields.')
    ...
    data_group = fill_pdf_parser.add_mutually_exclusive_group(True)
